...
<div class="container mt-4 form-container" style="margin-left: 240px;">
    ...
    <form id="studentForm" action="StudentServlet" method="POST">
        <div class="row mb-3">
            <div class="col-md-6">
                <label for="studentCode" class="form-label">Student Code (Auto-incremented)</label>
                <input type="number" class="form-control" id="studentCode" name="studentCode" placeholder="Enter student code">
                <span id="studentCodeError" class="text-danger"></span>
            </div>

            <div class="col-md-6">
                <label for="rollNumber" class="form-label">Roll Number</label>
                <input type="number" class="form-control" id="rollNumber" name="rollNumber" placeholder="Enter roll number">
                <span id="rollNumberError" class="text-danger"></span>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <span id="marksError" class="text-danger"></span>
            </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <span id="collegeError" class="text-danger"></span>
            </div>
